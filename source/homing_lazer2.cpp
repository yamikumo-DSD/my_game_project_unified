...
MyGameProject::HomingLazer2::HomingLazer2(decltype(target) _target, Real _angle, const Point2D& _p)
...
void MyGameProject::HomingLazer2::draw(void) const
{
	Point2D OM0, OM1;
...
void MyGameProject::HomingLazer2::hit(void)
{
	hit_flag = true;
}

bool MyGameProject::HomingLazer2::is_active(void) const
{
	return !hit_flag;
}

void MyGameProject::HomingLazer2::custom_updater(void)
{
...
MyGameProject::HomingLazer2::~HomingLazer2(void){}

void MyGameProject::HomingLazer2::preperation(void)
{
