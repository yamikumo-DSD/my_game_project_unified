...
MyGameProject::HomingShot2::HomingShot2(decltype(target) _target, Real _angle, const Point2D& _p)
...
void MyGameProject::HomingShot2::draw(void) const
{
	int i = 0;
...
void MyGameProject::HomingShot2::hit(void)
{
	hit_flag = true;
	count_of_hit = count;
}

bool MyGameProject::HomingShot2::is_active(void) const
{
	return !hit_flag;
}

void MyGameProject::HomingShot2::custom_updater(void)
{
...
MyGameProject::HomingShot2::~HomingShot2(void){}

void MyGameProject::HomingShot2::preperation(void)
{
