...
void MyVM::RepeatableVM::execute(void)
{
	if (continue_flag)
	{
		while (*get_pc() != Instruction::EOC && *get_pc() != Instruction::NEXT_FRAME)
		{
			switch (*get_pc())
			{
				case Instruction::USER_EXTENTION_0: user_extention_0(); break;
				case Instruction::USER_EXTENTION_1: user_extention_1(); break;
				case Instruction::USER_EXTENTION_2: user_extention_2(); break;
				case Instruction::USER_EXTENTION_3: user_extention_3(); break;
				case Instruction::USER_EXTENTION_4: user_extention_4(); break;
				case Instruction::USER_EXTENTION_5: user_extention_5(); break;
				case Instruction::USER_EXTENTION_6: user_extention_6(); break;
				case Instruction::USER_EXTENTION_7: user_extention_7(); break;
				case Instruction::USER_EXTENTION_8: user_extention_8(); break;
				case Instruction::USER_EXTENTION_9: user_extention_9(); break;
				case Instruction::USER_EXTENTION_10: user_extention_10(); break;
				case Instruction::USER_EXTENTION_11: user_extention_11(); break;
				case Instruction::USER_EXTENTION_12: user_extention_12(); break;
				case Instruction::USER_EXTENTION_13: user_extention_13(); break;
				case Instruction::USER_EXTENTION_14: user_extention_14(); break;
				case Instruction::USER_EXTENTION_15: user_extention_15(); break;
				case Instruction::USER_EXTENTION_16: user_extention_16(); break;
...
#else
						frame_stack.push(Frame(code_list[symbolic_ref.method_name].reserved_stack_size, code_list[symbolic_ref.method_name].size_of_local_variables));
#endif
						int i = 0;
